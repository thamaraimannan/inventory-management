export default {
  ...
  restocking: {
    ...
    adjustBudget: 'Adjust the budget slider and click "Get Recommendations" to see restocking suggestions.',
    noRecommendations: 'No items need restocking within this budget. Try increasing the budget.',
    ...
    recommendedItems: 'Recommended Restocking Items',
    status: {
      submitted: 'Submitted'
    },
    table: {
