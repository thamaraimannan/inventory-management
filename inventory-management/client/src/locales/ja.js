export default {
  ...
  restocking: {
    title: '補充',
    description: '需要予測に基づく補充注文の計画と提出',
    budgetLabel: '利用可能な予算',
    getRecommendations: '推薦を取得',
    placeOrder: '注文を発注',
    placingOrder: '注文中...',
    adjustBudget: '予算スライダーを調整して「推薦を取得」をクリックし、補充の提案を確認してください。',
    noRecommendations: 'この予算内で補充が必要な品目はありません。予算を増やしてみてください。',
    orderSuccess: '注文 {orderNumber} が正常に提出されました。',
